...
House::House()
{
    ...
    Vertex v2{-5.0f, 5.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v2);

    Vertex v3{-10.0f, 0.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v3);
    Vertex v4{-10.0f, 5.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v4);
    Vertex v5{-5.0f, 5.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v5);

    // Left wall
    Vertex v6{-10.0f, 0.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v6);
    Vertex v7{-10.0f, 0.0f, -5.0f, 0, 1, 0};   mVertices.push_back(v7);
    Vertex v8{-10.0f, 5.0f, -5.0f, 0, 1, 0};   mVertices.push_back(v8);

    Vertex v9{-10.0f, 0.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v9);
    Vertex v10{-10.0f, 5.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v10);
    Vertex v11{-10.0f, 5.0f, -5.0f, 0, 1, 0};   mVertices.push_back(v11);

    // Right wall
    Vertex v12{-5.0f, 0.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v12);
    Vertex v13{-5.0f, 0.0f, -5.0f, 0, 1, 0};   mVertices.push_back(v13);
    Vertex v14{-5.0f, 5.0f, -5.0f, 0, 1, 0};   mVertices.push_back(v14);

    Vertex v15{-5.0f, 0.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v15);
    Vertex v16{-5.0f, 5.0f, -10.0f, 0, 1, 0};   mVertices.push_back(v16);
